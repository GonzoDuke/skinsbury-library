...
New tags added to tag-vocabulary.json via the approval pipeline. Each entry records when a [Proposed] tag was accepted and added to the vocabulary.

---

## 2026-04-29 — Initial vocabulary

Created baseline vocabulary from 186-book LibraryThing export + 22-book proof of concept + 16-book shelf scan.
...
- Added `Survival skills` to **Geography, anthropology, recreation** (batch "Shelf 2026-05-05") — first seen on "Survive! Essential Skills and Tactics to Get You Out of Anywhere—alive" by Les Stroud
- Added `pop psychology` to **Philosophy, psychology, religion** (batch "Shelf 2026-05-05") — first seen on "The Subtle Art of Not Giving a F*ck" by Mark Manson
- Added `Psychopharmacology` to **Social sciences** (batch "Shelf 2026-05-05") — first seen on "Psychonauts" by Mike Jay
- Added `History of technology` to **World history** (batch "Shelf 2026-05-05") — first seen on "Paper" by Mark Kurlansky
